...
if __name__ == '__main__':
    ...
    path = r'E:\Nick\west'
    prefix_list = ['rubber d (rubber d)-#1 of 2-(-)', 'rubber d (rubber d)-#1 of 2-(+)','rubber e (rubber e)-#1 of 2-(-)', 'rubber e (rubber e)-#1 of 2-(+)', 'rubber f (rubber f)-#1 of 2-(-)', 'rubber f (rubber f)-#1 of 2-(+)']
